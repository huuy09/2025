...
cdef class py_Data:
    ...
    @property
    def s_t_node(self):
        return deref(self.inner_Data).s_t_node
    @property
    def s_t_edge(self):
        return deref(self.inner_Data).s_t_edge
    @property
    def a_t(self):
...
cdef class py_SumTree:
    ...
    def Add(self,p,pyData):
        ...
        deref(self.inner_Data).s_t_node= pyData.s_t_node
        deref(self.inner_Data).s_t_edge= pyData.s_t_edge
...
cdef class py_Memory:
    ...
    def Store(self,transition):
        ...
        deref(self.inner_Data).g=self.inner_Graph
        deref(self.inner_Data).s_t_node= transition.s_t_node
        deref(self.inner_Data).s_t_edge= transition.s_t_edge
        ...
        deref(self.inner_Data).s_prime_edge=transition.s_prime_edge
